...
# custom icon
penguIcon = folium.features.CustomIcon('pengu.jpeg', icon_size=(50, 50)) # create custom icon

# add marker to map
folium.Marker(  
    [-25.30220677071593, -57.58151499503942], 
    popup="<h1>Heladeria El Helado Feliz</h1> <img src='heladin.jpeg' width='250px'> <p>Abiertos desde 1806, cerrados cuando hay luna llena, pioneros en ingenieria heladil</p>", 
...
folium.Marker(  
    ...
    popup="<h1>Penguin House 2.0</h1> <img src='penguin_house.jpeg' width='250px'> <p>Si tu codigo no se rompio, algo estas haciendo mal kp.</p>", 
